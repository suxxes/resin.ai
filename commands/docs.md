...
Create comprehensive LLM-optimized documentation or update existing for specified components or features with concrete file references and flexible formatting.

## Your Task

Create or update documentation that allows humans and LLMs to:
