...
| → → TASK_TEST     | Phase {XX}: [{TT/ZZ}] [{II}] Quality Validation                       | Quality assurance agent for task validation         | Through-the-roof validation            |
...
| State Name        | Transition State    | Code     | Description                                                    |
|-------------------|---------------------|----------|----------------------------------------------------------------|
| STORY_DONE        | STORY_LOOP          | CONTINUE | Return control to story loop controller                        |
| STORY_LOOP        | STORY_INIT          | LOOP     | Start next unfinished story                                    |
| STORY_LOOP        | EXIT                | EXIT     | Only when all stories complete - exit orchestration            |
...
| STORY_LOOP        | Find next unfinished story in project → LOOP, only when all done → EXIT                         |
